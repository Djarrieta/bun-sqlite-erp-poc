...
export const REPORT_TABLES: readonly ReportTable[] = [
  ...
  },
  {
    module: "tasks",
    table: "tasks",
    description: "Tareas con estado, prioridad, fechas y responsables.",
    columns: [
      "id",
      "title",
      "description",
      ...
      "start_at (YYYY-MM-DDTHH:MM, may be empty)",
      "end_at (YYYY-MM-DDTHH:MM, may be empty)",
      "company_id -> companies.id",
      "project_id -> projects.id",
      "visit_id -> visits.id",
      "created_by -> users.id",
  ...
  },
  {
    ...
    description: "Asignación de una tarea a un usuario o rol.",
    columns: [
      "id",
      "task_id -> tasks.id",
      "kind ('user'|'role')",
  ...
  },
  {
    ...
    description: "Respuesta (aceptar/rechazar) de un usuario a una tarea.",
    columns: [
      "id",
      "task_id -> tasks.id",
      "user_id -> users.id",
